...
/* for demand paging */
		int 	private_heap;			/* is process created through vcreate/ has a prvate heap? 0 normal process, 1=> private heap*/
		int		backing_store_map[16];	/* Indicates to which Backing stores the process is mapped by having the corresponding bit as 1*/
